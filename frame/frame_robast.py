...
def frame_robast(column, row, sticky):
    ...
    robast_method_lb = ttk.Combobox(_3subframe1, values=robast_methods, textvariable=robast_method_value, state="readonly")
    robast_method_lb.place(x=5, y=5, relwidth=0.95)
