...
def plot_note_frame2():
    plotsubnote1 = ttk.Notebook(frames["note_frame2"])
    ...
    corr_matrix_T = plots_data["corr_matrix"]
    robast_matrix_T = plots_data["robast_matrix"]
    title = "Структура корреспонденций убывающего пассажиропотока \n по остановкам"
    plot_in_out(plotsubframe1, corr_matrix_T, title)
    plot_in_out(plotsubframe2, robast_matrix_T, title)
